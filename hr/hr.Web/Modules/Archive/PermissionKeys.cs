...
namespace hr.Evaluation
{
    ...
    public class PermissionKeys
    {
        ...
        [DisplayName("SelfEvaluationResult")]
        public class SelfEvaluationResult
        {
            public const string Delete = "Evaluation:SelfEvaluationResult:Delete";
            public const string Modify = "Evaluation:SelfEvaluationResult:Modify";
            public const string View = "Evaluation:SelfEvaluationResult:View";
        }
        ...
        public class Exam
        {
            ...
            public const string LookupScript = "Evaluation:Exam:LookupScript";
        }
        ...
        public class Department
        {
            public const string LookupScript = "Evaluation:Department:LookupScript";
        }
