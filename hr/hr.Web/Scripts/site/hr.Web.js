...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (EvaluationItemService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'GetSelfEvaluation', 'GetEvaluation1', 'GetEvaluation2'].forEach(function (x) {
                ...
                var res = Evaluation.EvaluationItemService.GetSelfEvaluation(null, function (response) {
                    ...
                    if (response !== null) {
                        ...
                        if (res.responseJSON.length !== 0) {
                            ...
                            html += "<tr><td colspan='4' class='text-center'><a href='PreviewSelfEvaluation0'><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i>\u4E0B\u4E00\u9875</a></td><tr></table>";
                        }
                        else {
