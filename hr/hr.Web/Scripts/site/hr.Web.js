...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (EvaluationItemService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'GetSelfEvaluation', 'GetEvaluation1', 'GetEvaluation2', 'GetSelfEvaluationByExam', 'GetEvaluation1ByExam', 'GetEvaluation2ByExam'].forEach(function (x) {
    ...
    (function (Evaluation) {
        var SelfEvaluation = (function () {
            ...
            SelfEvaluation.prototype.init = function () {
                ...
                var examId = parseInt(this.getQueryString("i", window.location.href));
                var res = Evaluation.EvaluationItemService.GetSelfEvaluationByExam({ ExamId: examId }, function (response) {
            ...
            SelfEvaluation.prototype.getQueryString = function (field, url) {
