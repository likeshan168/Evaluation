    ...
    (function (Evaluation) {
        var EvaluationResultDialog = (function (_super) {
            ...
            function EvaluationResultDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Evaluation.EvaluationResultForm(_this.idPrefix);
                return _this;
            }
            EvaluationResultDialog.prototype.getFormKey = function () { return Evaluation.EvaluationResultForm.formKey; };
            EvaluationResultDialog.prototype.getIdProperty = function () { return Evaluation.EvaluationResultRow.idProperty; };
            EvaluationResultDialog.prototype.getLocalTextPrefix = function () { return Evaluation.EvaluationResultRow.localTextPrefix; };
            EvaluationResultDialog.prototype.getService = function () { return Evaluation.EvaluationResultService.baseUrl; };
...
(function (hr) {
    ...
    (function (Evaluation) {
        var EvaluationResultGrid = (function (_super) {
            ...
            EvaluationResultGrid.prototype.getIdProperty = function () { return Evaluation.EvaluationResultRow.idProperty; };
            EvaluationResultGrid.prototype.getLocalTextPrefix = function () { return Evaluation.EvaluationResultRow.localTextPrefix; };
            EvaluationResultGrid.prototype.getService = function () { return Evaluation.EvaluationResultService.baseUrl; };
                ...
                var res = Evaluation.EvaluationItemService.GetSelfEvaluation(null, function (response) {
                    ...
                    if (response !== null) {
                        ...
                        if (res.responseJSON.length !== 0) {
                            ...
                            html += "<tr><td colspan='5' class='text-center'><a href='PreviewSelfEvaluation0'><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i>\u4E0B\u4E00\u9875</a></td><tr></table>";
                        }
                        else {
            ...
            SelfEvaluation.prototype.init = function () {
                ...
                hr.Evaluation.ToDoListService.GetCurrentUserId(null, function (userId) {
                    ...
                    var res = Evaluation.EvaluationItemService.GetSelfEvaluationByExam({ ExamId: examId, UserId: userId }, function (response) {
                        ...
                        if (response !== null) {
                            ...
                            if (res.responseJSON.length !== 0) {
                                res.responseJSON.forEach(function (item, index) {
                                    html += "<tr>";
                                    if (index == 0) {
                                        html += "<td rowspan='" + count_3 + "' style='vertical-align: middle;width:80px'><p class='text-primary'>" + item.FirstKpiName + "</p></td>";
                                    }
                        ...
                        var inputs = $("textarea.form-control");
                        var nexta = $("#nexta");
    ...
    (function (Evaluation) {
        var SelfEvaluation1 = (function () {
            ...
            SelfEvaluation1.prototype.onSelectChange = function (examId, sltUsers) {
                ...
                var res = Evaluation.EvaluationItemService.GetSelfEvaluationByExam({
                    ExamId: examId,
                    UserId: sltUsers.val()
                }, function (response) {
                    if (response !== null) {
                        ...
                        if (res.responseJSON.length !== 0) {
                            ...
                            res.responseJSON.forEach(function (item, index) {
                                html += "<tr>";
                                if (index == 0) {
                                    html += "<td rowspan='" + count_4 + "' style='vertical-align: middle;width:80px'><p class='text-primary'>" + item.FirstKpiName + "</p></td>";
                                }
                                html += "<td width='80px'><p class='text-success'>" + item.SecondKpiName + "</p></td>\n                                    <td width='150px'><p class='text-info'>" + item.Content + "</p></td>";
                                if (item.ContentType === 1) {
                                    //输入框
...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (EvaluationItemService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'GetSelfEvaluation', 'GetEvaluation1', 'GetEvaluation2', 'GetSelfEvaluationByExam', 'GetEvaluation1ByExam', 'GetEvaluation2ByExam', 'GetUserToUsers'].forEach(function (x) {
...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (EvaluationResultDetailRow) {
            ...
            ['Id', 'ExamId', 'EvaluationItemId', 'InputContent', 'Score', 'UserId'].forEach(function (x) { return Fields[x] = x; });
...
(function (hr) {
    var Evaluation;
    (function (Evaluation) {
        var EvaluationResultForm = (function (_super) {
            __extends(EvaluationResultForm, _super);
            function EvaluationResultForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return EvaluationResultForm;
        }(Serenity.PrefixedContext));
        EvaluationResultForm.formKey = 'Evaluation.EvaluationResult';
        Evaluation.EvaluationResultForm = EvaluationResultForm;
        [['UserId', function () { return Serenity.IntegerEditor; }], ['ExamId', function () { return Serenity.IntegerEditor; }], ['TotalScore', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(EvaluationResultForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Evaluation = hr.Evaluation || (hr.Evaluation = {}));
})(hr || (hr = {}));
var hr;
(function (hr) {
    var Evaluation;
    (function (Evaluation) {
        var EvaluationResultRow;
        (function (EvaluationResultRow) {
            EvaluationResultRow.idProperty = 'Id';
            EvaluationResultRow.localTextPrefix = 'Evaluation.EvaluationResult';
            var Fields;
            (function (Fields) {
            })(Fields = EvaluationResultRow.Fields || (EvaluationResultRow.Fields = {}));
            ['Id', 'UserId', 'ExamId', 'TotalScore', 'UserUsername', 'ExamTitle'].forEach(function (x) { return Fields[x] = x; });
        })(EvaluationResultRow = Evaluation.EvaluationResultRow || (Evaluation.EvaluationResultRow = {}));
    })(Evaluation = hr.Evaluation || (hr.Evaluation = {}));
})(hr || (hr = {}));
var hr;
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (EvaluationResultService) {
            EvaluationResultService.baseUrl = 'Evaluation/EvaluationResult';
            var Methods;
            (function (Methods) {
            })(Methods = EvaluationResultService.Methods || (EvaluationResultService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'Add'].forEach(function (x) {
                EvaluationResultService[x] = function (r, s, o) { return Q.serviceRequest(EvaluationResultService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = EvaluationResultService.baseUrl + '/' + x;
            });
        })(EvaluationResultService = Evaluation.EvaluationResultService || (Evaluation.EvaluationResultService = {}));
    })(Evaluation = hr.Evaluation || (hr.Evaluation = {}));
})(hr || (hr = {}));
var hr;
(function (hr) {
...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        [['UserId', function () { return Serenity.LookupEditor; }], ['StartDate', function () { return Serenity.DateEditor; }], ['EndDate', function () { return Serenity.DateEditor; }], ['Title', function () { return Serenity.StringEditor; }], ['Content', function () { return Serenity.TextAreaEditor; }], ['ExamId', function () { return Serenity.LookupEditor; }], ['CreateBy', function () { return Serenity.LookupEditor; }]].forEach(function (x) { return Object.defineProperty(ToDoListForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Evaluation = hr.Evaluation || (hr.Evaluation = {}));
})(hr || (hr = {}));
var hr;
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (ToDoListRow) {
            ...
            ['Id', 'UserId', 'Title', 'Content', 'IsComplete', 'UserUsername', 'StartDate', 'EndDate', 'CreateBy', 'CreateByUsername', 'Url', 'ExamId', 'ExamTitle'].forEach(function (x) { return Fields[x] = x; });
