                        ...
                        if (response !== null) {
                            ...
                            if (res.responseJSON.length !== 0) {
                                res.responseJSON.forEach(function (item, index) {
                                    html += "<tr>";
                                    if (index == 0) {
                                        html += "<td rowspan='" + count_3 + "' style='vertical-align: middle;width:80px'><p>" + item.FirstKpiName + "</p></td>";
                                    }
                    ...
                    if (response !== null) {
                        ...
                        if (res.responseJSON.length !== 0) {
                            ...
                            res.responseJSON.forEach(function (item, index) {
                                html += "<tr>";
                                if (index == 0) {
                                    html += "<td rowspan='" + count_4 + "' style='vertical-align: middle;width:80px'><p>" + item.FirstKpiName + "</p></td>";
                                }
                                html += "<td width='80px'><p>" + item.SecondKpiName + "</p></td>\n                                    <td width='150px'><p>" + item.Content + "</p></td>";
                                if (item.ContentType === 1) {
                                    //输入框
