...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        [['UserUsername', function () { return Serenity.StringEditor; }], ['ParentUserId', function () { return Serenity.LookupEditor; }]].forEach(function (x) { return Object.defineProperty(LeaderShipForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Evaluation = hr.Evaluation || (hr.Evaluation = {}));
})(hr || (hr = {}));
var hr;
(function (hr) {
...
(function (hr) {
    ...
    (function (Evaluation) {
        ...
        (function (UserToUserViewRow) {
            ...
            ['Id', 'UserId', 'ExamId', 'EvaluationUserId', 'Email', 'Username', 'HasEvaluated'].forEach(function (x) { return Fields[x] = x; });
        ...
        var Evaluation2 = (function () {
            ...
            Evaluation2.prototype.init = function () {
                ...
                var res = Evaluation.EvaluationItemService.GetEvaluation2ByExam({
                    ...
                    preva.click(function (e) {
                        e.preventDefault();
                        if (checkedRd.length > 0 && Q.any(checkedRd, function (p) { return $(p).parent().parent().parent().hasClass('text-danger'); })) {
                            Q.confirm('数据未保存，您确认离开此页面吗？', function () {
                                window.location.href = preva.attr('href');
                            });
                        }
                        ...
                        if (response !== null) {
                            ...
                            if (res.responseJSON.length !== 0) {
                                res.responseJSON.forEach(function (item, index) {
                                    html += "<tr>";
                                    if (index == 0) {
                                        html += "<td rowspan='" + count_1 + "' style='vertical-align: middle;width:80px'><p class='text-primary'>" + item.FirstKpiName + "</p></td>";
                                    }
                    ...
                    if (response !== null) {
                        ...
                        if (res.responseJSON.length !== 0) {
                            ...
                            res.responseJSON.forEach(function (item, index) {
                                html += "<tr>";
                                if (index == 0) {
                                    html += "<td rowspan='" + count_2 + "' style='vertical-align: middle;width:80px'><p class='text-primary'>" + item.FirstKpiName + "</p></td>";
                                }
                                html += "<td width='80px'><p class='text-success'>" + item.SecondKpiName + "</p></td>\n                                    <td width='150px'><p class='text-info'>" + item.Content + "</p></td>";
                                if (item.ContentType === 1) {
                                    //输入框
...
(function (hr) {
    ...
    (function (Evaluation) {
        var LeaderShipGrid = (function (_super) {
            ...
            LeaderShipGrid.prototype.getButtons = function () {
                return [];
            };
