namespace hr.Evaluation {
    export namespace ExamService {
        export const baseUrl = 'Evaluation/Exam';
        ...
        export declare function Archive(request: ArchiveRequest, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'Archive'].forEach(x => {
            (<any>ExamService)[x] = function (r, s, o) { return Q.serviceRequest(baseUrl + '/' + x, r, s, o); };
