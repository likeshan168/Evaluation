namespace hr.Evaluation {
    export namespace EvaluationResultViewService {
        ...
        export declare function BatchSendNotifyEmail(request: BatchUserEmailRequest, onSuccess?: (response: System.Boolean) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export namespace Methods {
            ...
            export declare const BatchSendNotifyEmail: string;
        }

        ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'SendNotifyEmail', 'BatchSendNotifyEmail'].forEach(x => {
