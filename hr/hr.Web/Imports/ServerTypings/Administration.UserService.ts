namespace hr.Administration {
    export namespace UserService {
        ...
        export declare function BatchUpdate(request: BatchUpdateUserRequest, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export namespace Methods {
            ...
            export declare const BatchUpdate: string;
        ...
        ['Create', 'Update', 'BatchUpdate', 'Delete', 'Undelete', 'Retrieve', 'List'].forEach(x => {
